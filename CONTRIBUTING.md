# Contributing to eslint-disable-files
...
[issue and pull request labels](https://github.com/BorysShulyak/eslint-disable-files/blob/main/documentation/LABELS.md)
...
more information you could read the [CODE_REVIEW document](https://github.com/BorysShulyak/eslint-disable-files/blob/main/documentation/CODE_REVIEW.md).

## Local development
Clone repository:
```shell
git clone git@github.com:BorysShulyak/eslint-disable-files.git
```
